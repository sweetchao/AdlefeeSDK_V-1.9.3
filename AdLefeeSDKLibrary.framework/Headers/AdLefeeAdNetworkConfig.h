...
@class AdLefeeAdapterNetworkRegistry;
@interface AdLefeeAdNetworkConfig : NSObject
- (id)initWithDictionary:(NSDictionary *)adNetConfigDict
 adAPISDKNetworkRegistry:(AdLefeeAdapterNetworkRegistry *)registry;
//2016 9 - 29 信息流调用初始化方法
- (id)initWithDictionary:(NSDictionary *)adNetConfigDict
 adAPISDKNetworkRegistry:(AdLefeeAdapterNetworkRegistry *)registry withTypeSize:(NSString *)typeSize;
...
@property (nonatomic,assign,readonly) AdLefeeAdNetworkType networktype;// 平台适配器编号
