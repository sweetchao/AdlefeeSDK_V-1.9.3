...
#import "AdLefeeNativeAdNetworkAdapter.h"
@interface AdLefeeNativeAdInfo : NSObject
...
@property(nonatomic,strong) AdLefeeNativeAdNetworkAdapter * adapter;
